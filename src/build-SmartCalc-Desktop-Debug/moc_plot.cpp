...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Plot_t, stringdata0) + ofs), len 
...
const QMetaObject Plot::staticMetaObject = { {
    ...
    qt_meta_stringdata_Plot.offsetsAndSize,
    qt_meta_data_Plot,
    qt_static_metacall,
    nullptr,
